...
export const MediaService = {
    UPLOAD_SINGLE_IMAGE: function({username, password, csrfToken, formData, fileName}){
    ...
    UPLOAD_MULTIPLE_IMAGES: function({username, password, csrfToken, formData, filesNames}){
